...
Finding an optimal value of $x={a,𝛾}$ can maximize the sessions without compromising on CTR and send volume. To ensure the overall performance, they used $c1$ and $c2$ constraints as contained for CTR(x), and Send Volume(x).
...
By converting a MOO into SOO using constraint-based optimization, they learn global hyperparameters (i.e., a single value) for all members. 
