...
In a multi-sided system with multiple bjectives often the objectives interact and behave in differnet manners. At a high level, you could categorise the different types of these interplay as follows: 
...
read more about this in [Towards a Fair Marketplace: Counterfactual Evaluation of the trade-off between Relevance, Fairness & Satisfaction in Recommendation Systems](http://rishabhmehrotra.com/papers/CIKM2018-marketplace-mehrotra.pdf)
