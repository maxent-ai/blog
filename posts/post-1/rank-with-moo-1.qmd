---
title: "Rank, Rank & Rank: A Long Notes"
subtitle: "Part I - An Overview of Recommendation systems, LTR, Ranking Evaluation Metrics & Multiple Objective Optimisation for Ranking."
...
$$\begin{eqnarray} P@k(q) \equiv \frac{\sum_{i=1}^k r_i}{k} \end{eqnarray}$$
...
$$\begin{eqnarray} AP(q)@k \equiv \frac{1}{\sum_{i=1}^k r_i} \sum_{i=1}^k P@i(q) \times r_i \end{eqnarray}$$
...
__*Next in Series - MOO Ranking via Scalarisation - The Fine Print*__, In which we will do a deep dive of various approaches to scalarisation and a survey on how it's done in the industry, with a reference example implementation & system design.
